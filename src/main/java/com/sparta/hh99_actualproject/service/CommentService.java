...
public class CommentService {
    ...
    //댓글 저장
    @Transactional
    public CommentResponseDto addComment(String boardId , CommentRequestDto commentRequestDto) {
        ...
        return commentRepository.findByContent(commentRequestDto.getContent());
    }
    ...
    //댓글 수정
    @Transactional
    public void updateComment(String boardId , Long commentId ,CommentRequestDto commentRequestDto) {
        //인터셉터의 jwt token의 memberid를 받아온다.
        String memberId = SecurityUtil.getCurrentMemberId();
    ...
    //댓글 삭제
    @Transactional
    public void deleteComment(String boardId , Long commentId){
        //인터셉터의 jwt token의 memberid를 받아온다.
        String memberId = SecurityUtil.getCurrentMemberId();
